...
# Verify that a 404 (Not found ) error is returned a non-expecting product ($PRODUCT_ID_NOT_FOUND)
assertCurl 404 "curl http://$HOST:$PORT/product-composite/$PRODUCT_ID_NOT_FOUND"
...
#Verify thar no reviews  are returned for productId $PRODUCT_ID_NO_REVS
...
echo "End, all tests dye OK:" `date`